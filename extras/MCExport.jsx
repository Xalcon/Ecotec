...
(function(doc)
{
	...
	{
		var set = data.sets[i];
		// disable all groups in elements
		var elems = doc.layerSets.getByName("Elements");
		for(var e = 0; e < elems.layerSets.length; e++)
		{
			elems.layerSets[e].visible = false;
		}
		
		for(var s = 0; s < set.elements.length; s++)
		{
			var elemKeep = set.elements[s];
			elems.layerSets.getByName(elemKeep).visible = true;
		}
